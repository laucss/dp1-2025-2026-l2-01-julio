...
| 1.4 | 06/07/2026 | 1 | Nerea Camacho Pérez | ChatGPTPro | Web | https://chatgpt.com/share/6a4eb0fb-5b20-83eb-9412-6cb3ff66e2a1 | Error al filtrar las partidas que abandonó el usuario en el historial | MatchService.java, MatchRepository.java, PlayerInGameDTO.java y MatchHistorialDTO.java| El alumno eligió entre las opciones ofrecidas y además entendió de donde venía el error | No hubo ningún riesgo al ser una funcionalidad que solo se usa en una pantalla | Aceptado parcialmente, se aceptó aquella que se consideró más apropiada dada la situación del proyecto en dicho momento |
| 1.5 | 04/07/2026 | 1 | Nerea Camacho Pérez | ChatGPTPro | Web |https://chatgpt.com/share/6a4eb2e1-f48c-83eb-bd3c-602012be367a | Error al cambiar la foto del fondo de pantalla | Index.js| El alumno entendió el lugar donde había que importar la imagen| No hubo riesgos al simplemente ser la imagen de fondo |  Aceptado completamente|
