...
@DisplayName("NpcPositionDTO Tests")
public class NpcPositionDTOTest {

    private NpcPositionDTO dto;

    @BeforeEach
    void setUp() {
        dto = new NpcPositionDTO();
    }

    @Test
    @DisplayName("Should create empty NpcPositionDTO with default constructor")
    ...
    @Test
    @DisplayName("Should create NpcPositionDTO with all fields via constructor")
    void testConstructorWithAllFields() {
        NpcPositionDTO dto = new NpcPositionDTO(1, 10, 1234567890L);
    ...
    @Test
    @DisplayName("Should update npcId from non-null to different value")
    void testUpdateNpcId() {
        dto.setNpcId(1);
        assertThat(dto.getNpcId()).isEqualTo(1);
    ...
    @Test
    @DisplayName("Should handle large npcId values")
    void testLargeNpcId() {
    ...
    void testToString() {
        ...
        assertThat(result).contains("npcId=1");
    ...
    void testIndependentInstances() {
        NpcPositionDTO dto1 = new NpcPositionDTO(1, 10, 1000L);
        NpcPositionDTO dto2 = new NpcPositionDTO(2, 20, 2000L);
        ...
        dto1.setNpcId(99);
        assertThat(dto2.getNpcId()).isEqualTo(2);
    }
    ...
    void testZeroValues() {
        ...
        assertThat(dto.getNpcId()).isEqualTo(0);
    ...
    void testEqualsAndHashCode() {
        NpcPositionDTO dto1 = new NpcPositionDTO(1, 10, 1000L);
        NpcPositionDTO dto2 = new NpcPositionDTO(1, 10, 1000L);
        NpcPositionDTO dto3 = new NpcPositionDTO(2, 20, 2000L);
