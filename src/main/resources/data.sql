...
VALUES (1,'Fiesta para todos!!! ÚNETE!',NULL, 'WAITING',NULL,NULL,6,3,3,false,null);
...
-- Actualizar ganadores de partidas finalizadas
UPDATE match SET winner_id = 11 WHERE id = 6;
UPDATE match SET winner_id = 13 WHERE id = 7;
